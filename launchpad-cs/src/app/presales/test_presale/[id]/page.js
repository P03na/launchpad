      ...
      <div className="flex-auto w-[892px] max-sm:w-[100%] flex flex-col gap-8">
        <div className="bg-[#1B1B1B] rounded-[16px]">
          <div className="relative">
            ...
            {/* <div className="flex flex-row ml-[199px] items-center mt-2">
              ...
              <div className="py-2 px-3 rounded-[40px] bg-[#C03F4A]/[0.1] text-xs text-[#C03F4A] ml-2 max-sm:hidden">
                Flash Transfer
              </div>
            </div> */}
          </div>
        ...
        <div className="bg-[#1B1B1B] rounded-[16px]">
          ...
          <div className="py-6 px-7">
            ...
            <div className="text-base text-[#C03F4A] underline text-center mt-3 cursor-pointer">
              View all
            </div>
          </div>
        </div>
      ...
      <div className="flex-auto w-[631px] max-sm:w-[100%] flex flex-col gap-8">
        <div>
          ...
          <div className="bg-[#1B1B1B] rounded-[16px] p-7 flex flex-col gap-6">
            <div className="py-[10px] px-[17px] border border-[#B78103] bg-[#7A4F01]/[.06] text-[#FFF7CD] text-sm rounded-lg">
              Make sure the website is TaikoPad!
            </div>

            <div className="flex flex-col items-center gap-3">
              <p className="text-white text-base">Presales Ends In</p>
              <div className="flex flex-row gap-2">
                <div className="w-[36px] h-[36px] bg-[#C03F4A] flex-col flex justify-center items-center text-[#16171B] text-base rounded-[4px] font-bold">
                  01
                </div>
                <div className="w-[36px] h-[36px] bg-[#C03F4A] flex-col flex justify-center items-center text-[#16171B] text-base rounded-[4px] font-bold">
                  23
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="relative">
                ...
                />
                <div className="text-base text-[#C03F4A] font-bold absolute top-3 right-3 cursor-pointer">
                  MAX
                </div>
              </div>
              <button
                className="w-[150px] h-[43px] flex flex-col items-center justify-center bg-[#FA8B84] outline-none rounded-[10px] text-sm text-[#151103]"
                onClick={() => {
            ...
            <div className="text-[#C03F4A] text-base underline cursor-pointer">
              Affiliate detail
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#1B1B1B] rounded-[16px] p-7">
          <div className="h-[16px] w-[100%] bg-[#282828] rounded-[40px]">
            <div className="h-[16px] w-[137px] bg-[#C03F4A] rounded-[40px]"></div>
          </div>
          ...
          <div className="flex flex-col">
            <div className="flex flex-row text-base text-white py-4 justify-between border-b border-[#2C2C2C]">
              <p>Status</p>
              <p className="text-[#C03F4A]">Inprogress</p>
            </div>
            <div className="flex flex-row text-base text-white py-4 justify-between border-b border-[#2C2C2C]">
              <p>Sale Type</p>
              <p className="text-[#C03F4A]">Public</p>
            </div>
            <div className="flex flex-row text-base text-white py-4 justify-between border-b border-[#2C2C2C]">
              <p>Minimum Buy</p>
              <p>0.4 BNB</p>
        ...
        <div className="bg-[#1B1B1B] rounded-[16px] p-7">
          ...
          <div className="mt-3 flex flex-col text-white text-base">
            ...
            <div className="flex flex-row items-center py-4 border-b border-[#2C2C2C]">
              ...
              <div className="flex flex-row gap-2">
                ...
                <div className="text-[#C03F4A] text-base">PancakeSwap</div>
              </div>
            </div>
            <div className="flex flex-row items-center py-4 border-b border-[#2C2C2C]">
              <div className="w-[204px]">Listed On</div>
              <div className="flex flex-row gap-2">
                ...
                <div className="text-[#C03F4A] text-base">Bubblemaps</div>
              </div>
            </div>
            <div className="flex flex-row items-center py-4 border-b border-[#2C2C2C]">
              ...
              <div className="flex flex-row gap-2">
                ...
                <div className="text-[#C03F4A] text-base">GeckoTerminal</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col mt-3">
            <div className="flex flex-row gap-[60px] items-center py-4 border-b border-[#2C2C2C]">
              ...
              <div className="text-base text-[#C03F4A]">true</div>
            </div>
            <div className="flex flex-row gap-[60px] items-center py-4 border-b border-[#2C2C2C]">
              <div className="w-[145px] text-white text-base">Buy Tax</div>
              <div className="text-base text-[#C03F4A]">5%</div>
            </div>
            <div className="flex flex-row gap-[60px] items-center py-4 border-b border-[#2C2C2C]">
              <div className="w-[145px] text-white text-base">Sell Tax</div>
              <div className="text-base text-[#C03F4A]">10%</div>
            </div>
            <div className="flex flex-row gap-[60px] items-center py-4 border-b border-[#2C2C2C]">
              <div className="w-[145px] text-white text-base">Mintable</div>
              <div className="text-base text-[#C03F4A]">false</div>
            </div>
            <div className="flex flex-row gap-[60px] items-center py-4 border-b border-[#2C2C2C]">
              <div className="w-[145px] text-white text-base">
                Transfer Pausable
          ...
          <div className="text-[#C03F4A] text-base mt-4 cursor-pointer">
            More info
          </div>
        </div>
          ...
          <div className="flex flex-col p-7">
            ...
            <div className="flex flex-col items-center text-white text-sm mt-6 gap-2">
              <div className="flex flex-row items-center justify-center gap-6">
                <div className="flex flex-row items-center gap-1">
                  <div className="w-[12px] h-[12px] bg-[#C03F4A] rounded-full"></div>
                  <p>Presale</p>
                </div>
                <div className="flex flex-row items-center gap-1">
            ...
            <div className="flex flex-col">
              <div className="flex flex-row justify-between py-4 border-b border-[#2C2C2C] text-white text-base">
                <p>Lock Addresses:</p>
                <p className="text-[#C03F4A]">0x1aE...482E3</p>
              </div>
              <div className="flex flex-row justify-between py-4 border-b border-[#2C2C2C] text-white text-base">
                <p>100,000,000</p>
